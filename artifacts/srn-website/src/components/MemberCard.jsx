export default function MemberCard({ initials, nameHindi, name, batch, qualification, role }) {
  return (
    <div className="bg-white rounded-xl p-6 border border-[#F0D5B8] shadow-sm hover:shadow-lg hover:border-[#E8622A] hover:-translate-y-1 transition-all duration-300 card-shimmer h-full">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-[#1E0F05] text-lg leading-tight font-serif">{nameHindi}</h3>
          <p className="text-[#7A5C45] text-sm mt-0.5">{name}</p>
